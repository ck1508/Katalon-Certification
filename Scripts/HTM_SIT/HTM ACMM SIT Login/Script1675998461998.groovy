...
WebUI.setText(findTestObject('Object Repository/Page_ACMM/input_Supplier_itemSupplierForm.supplierDisplay'), '0000000014 - APPLE INTERNATIONAL')
...
//	if (WebUI.getText(findTestObject('Object Repository/HTM ACMM SIT/Page_Login/AlertButton')).length() > 0) {
//		
...
//	}
	...
	System.out.println('\nLength : ' + WebUI.getText(findTestObject('Object Repository/HTM ACMM SIT/Page_Login/AlertButton')).length())
	
	System.out.println('\nError : ' + WebUI.getText(findTestObject('Object Repository/HTM ACMM SIT/Page_Login/AlertButton')) + '\n')
	
	System.out.println('\nField(s) : ' + '\n' + WebUI.getText(findTestObject('Object Repository/HTM ACMM SIT/Page_Login/AlertMessage')) + '\n')
